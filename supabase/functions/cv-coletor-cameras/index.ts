...
Deno.serve(async (req) => {
  ...
  try {
    ...
    let camQ = supabase
      .from("cv_cameras")
      .select("id,nome,marca,tipo_rede,host,porta,protocolo,usuario,senha,snapshot_path,angulo_key,grupo_id,filial_id,tem_ptz,tem_audio,onvif_user,onvif_pass,onvif_porta,ptz_velocidade_padrao,modo_manual,rtsp_porta,rtsp_path,rtsp_user,rtsp_pass,rtsp_transporte")
      .eq("ativo", true);
