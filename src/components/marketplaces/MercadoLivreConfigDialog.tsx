...
import { Loader2, Key, Link, Save, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export function MercadoLivreConfigDialog({
  open,
  onOpenChange,
  contaId,
  contaNome,
  ...
  const handleSave = async () => {
    ...
    try {
      const { error } = await supabase
        ...
        .update({
          configuracoes: {
            ...
            ml_redirect_uri: config.redirect_uri,
          },
        })
        .eq("id", contaId);
      ...
      // Buscar estabelecimento_id da conta
      ...
      if (contaData?.estabelecimento_id) {
        await supabase.from("marketplace_logs").insert({
          ...
          tipo: "config",
          mensagem: "Credenciais do Mercado Livre configuradas",
          sucesso: true,
        });
      }
        ...
        <div className="space-y-4 py-4">
          <Alert>
            ...
            <AlertDescription className="text-xs">
              ...
              . Configure a Redirect URI exatamente como cadastrada no app.
            </AlertDescription>
          </Alert>
