...
interface FluxoAtendimentoDialogProps {
  open: boolean;
...
export function FluxoAtendimentoDialog({
  open,
  onOpenChange,
  tasks,
  estabelecimentoId,
  ...
  useEffect(() => {
    // Atualizar data sugerida quando mudar tipo de contato
  ...
  // Reset state when changing task
  useEffect(() => {
