...
export function StrategyTimeline({ executions, onExecuteAgent, runningAgent, isPipelineRunning }: Props) {
            ...
            <CardContent className="p-3 flex items-center gap-3">
              ...
              >
                ...
                <span className="ml-1 text-xs">
                  {isCompleted ? 'Reexecutar' : isFailed ? 'Tentar Novamente' : 'Executar'}
                </span>
              </Button>
            </CardContent>
          </Card>
