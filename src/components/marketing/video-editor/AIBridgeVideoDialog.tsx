...
const ALL_VIDEO_MODELS: VideoModelInfo[] = [
  ...
  { value: 'apiframe/pika', label: '⚡ AF: Pika', provider: 'apiframe', cost: '$$', disabled: true },
  { value: 'apiframe/hailuo-minimax', label: '⚡ AF: Hailuo MiniMax', provider: 'apiframe', cost: '$', disabled: true },
  { value: 'apiframe/wan-video', label: '⚡ AF: Wan Video', provider: 'apiframe', cost: '$', disabled: true },
  { value: 'apiframe/vidu', label: '⚡ AF: Vidu', provider: 'apiframe', cost: '$', disabled: true },
  { value: 'apiframe/pixverse', label: '⚡ AF: Pixverse', provider: 'apiframe', cost: '$', disabled: true },
  { value: 'apiframe/seedance', label: '⚡ AF: Seedance', provider: 'apiframe', cost: '$', disabled: true },
  // AIML API
