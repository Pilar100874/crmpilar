              ...
              <div className="space-y-1">
                {cat.nodes.map((node) => (
                  <div
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg border bg-background cursor-grab active:cursor-grabbing hover:border-primary/50 hover:shadow-sm transition-all text-sm group"
