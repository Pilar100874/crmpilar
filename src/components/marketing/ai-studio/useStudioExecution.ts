      ...
      case 'imageGen': {
        ...
        if (hasProduct && hasInfluencer && !hasPlacementHint) {
          enrichedPrompt = [
            ...
            `     • APRESENTAR: Pessoa com uma mão no produto e outra gesticulando, como em um anúncio de TV`,
            `     • OFERECER: Pessoa estendendo o produto em direção à câmera com um sorriso convidativo`,
            ...
            `   - A mão que segura o produto deve ter posição NATURAL (dedos envolvendo a embalagem realisticamente)`,
            ``,
