...
const PRESETS: Preset[] = [
  ...
  { id: 'ascend', name: 'Ascender', description: 'Câmera sobe verticalmente revelando a cena de cima, estilo drone.', prompt: 'Câmera ascendendo verticalmente revelando a cena de cima, estilo elevação de drone', image: camAscend, category: 'camera', toolType: 'videoGen' },
  { id: 'follow', name: 'Seguir', description: 'Câmera segue o sujeito mantendo enquadramento constante.', prompt: 'Câmera seguindo o sujeito mantendo enquadramento constante durante o movimento', image: camFollow, category: 'camera', toolType: 'videoGen' },
  { id: 'flythrough', name: 'Fly-through', description: 'Câmera voa através da cena, atravessando ambientes.', prompt: 'Câmera voando através da cena, passando pelos ambientes de forma imersiva', image: camFlythrough, category: 'camera', toolType: 'videoGen' },
  { id: 'orbit', name: 'Órbita', description: 'Câmera gira ao redor do sujeito em movimento circular.', prompt: 'Câmera orbitando ao redor do sujeito em movimento circular mantendo foco central', image: camOrbit, category: 'camera', toolType: 'videoGen' },
  { id: 'crane', name: 'Grua', description: 'Movimento vertical suave como uma grua cinematográfica.', prompt: 'Movimento suave de grua vertical revelando a extensão completa da cena', image: camCrane, category: 'camera', toolType: 'videoGen' },
  { id: 'steadicam', name: 'Steadicam', description: 'Movimento estabilizado acompanhando o sujeito profissionalmente.', prompt: 'Movimento steadicam estabilizado suave acompanhando o sujeito profissionalmente', image: camSteadicam, category: 'camera', toolType: 'videoGen' },
  { id: 'mounted', name: 'Câmera Montada', description: 'Fixada em veículo em movimento, perspectiva dinâmica.', prompt: 'Câmera montada em veículo em movimento capturando velocidade e perspectiva dinâmica', image: camMounted, category: 'camera', toolType: 'videoGen' },
  { id: 'rotation', name: 'Rotação 360°', description: 'Rotação completa ao redor do objeto mostrando todos os ângulos.', prompt: 'Rotação de 360 graus ao redor do objeto mostrando todos os ângulos com movimento contínuo', image: camRotation, category: 'camera', toolType: 'videoGen' },
  { id: 'rise', name: 'Elevar', description: 'Sujeito se eleva dramaticamente com câmera acompanhando.', prompt: 'Sujeito se elevando dramaticamente na cena com câmera acompanhando o movimento ascendente', image: camRise, category: 'camera', toolType: 'videoGen' },
  { id: 'pan', name: 'Pan Horizontal', description: 'Câmera gira horizontalmente varrendo a paisagem.', prompt: 'Câmera fazendo panorâmica horizontal varrendo a paisagem', image: camPan, category: 'camera', toolType: 'videoGen' },
  { id: 'tilt', name: 'Tilt Vertical', description: 'Câmera inclina verticalmente revelando do chão ao céu.', prompt: 'Câmera inclinando verticalmente revelando gradualmente do chão ao céu', image: camTilt, category: 'camera', toolType: 'videoGen' },
  { id: 'zoomin', name: 'Zoom In', description: 'Aproximação gradual criando foco e intimidade.', prompt: 'Zoom gradual em detalhe específico criando foco e intimidade', image: camZoomin, category: 'camera', toolType: 'videoGen' },
  { id: 'handheld', name: 'Câmera na Mão', description: 'Tremor natural criando sensação documental e imersiva.', prompt: 'Câmera na mão com tremor natural criando sensação documental e imersiva', image: camHandheld, category: 'camera', toolType: 'videoGen' },
  { id: 'charswap', name: 'Troca de Personagem', description: 'Morphing suave entre dois sujeitos diferentes na mesma cena.', prompt: 'Troca de personagem com morphing suave entre dois sujeitos na mesma cena', image: fxCharswap, category: 'camera', toolType: 'videoGen' },
];
