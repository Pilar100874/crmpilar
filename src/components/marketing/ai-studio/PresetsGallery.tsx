...
const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    description: 'Escolha quais referências o preset precisa. Cada opção gera o bloco unificado correspondente: Produtos, Imagens de Referência ou Galeria de Referência (com a categoria correta).',
    multiple: true,
    options: [
      { id: 'productImageSelect', label: 'Produtos', emoji: '📦' },
      ...
      { id: 'imageInput', label: 'Imagens de Referência (genéricas)', emoji: '🖼️' },
    ],
  },
