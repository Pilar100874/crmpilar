...
const PRESETS: Preset[] = [
  // ===== VÍDEO (com animação) =====
  {
    ...
    description: 'Cena de abertura com câmera sobrevoando uma paisagem ao pôr do sol, transição suave.',
  ...
  },
  {
    ...
    description: 'Objeto decorativo girando 360° em fundo estúdio com iluminação suave, perfeito para e-commerce.',
  ...
  },
  {
    ...
    name: 'Câmera Lenta',
    description: 'Cena em câmera lenta de gotas de água caindo, revelando detalhes invisíveis a olho nu.',
  ...
  },
  {
    id: 'video-dolly-zoom',
    name: 'Efeito Vertigo',
    description: 'Efeito Dolly Zoom clássico — zoom e movimento simultâneos criando uma distorção visual única.',
    prompt: 'A smooth dolly zoom effect on a long empty hallway with natural lighting, the background appears to stretch as the camera moves forward, creating a mesmerizing visual illusion',
    image: fxDollyzoom,
    category: 'video',
    toolType: 'videoGen',
    isVideo: true,
  },
  {
    ...
    description: 'Transições suaves entre velocidades — desacelera e acelera fluidamente na mesma cena.',
    prompt: 'A colorful paint splash in mid-air with smooth speed ramping effect, transitioning from normal speed to slow motion and back, vibrant colors against white background, artistic style',
    image: fxSpeedramp,
    category: 'video',
    toolType: 'videoGen',
    isVideo: true,
  },
  {
    ...
    name: 'Seguir Objeto',
    description: 'Câmera seguindo um objeto em movimento, mantendo enquadramento constante durante toda a cena.',
    prompt: 'A camera smoothly tracking and following a paper boat floating down a gentle stream, steady framing, soft natural daylight, peaceful cinematic footage',
    image: camFollow,
    category: 'video',
    toolType: 'videoGen',
    isVideo: true,
