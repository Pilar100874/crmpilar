...
export const NODE_CATEGORIES: NodeCategory[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        description: 'Carregue uma ou mais imagens (upload ou galeria) e defina o papel (produto, influencer, ambiente, estilo, etc.)',
        icon: '🖼️',
        color: '#f97316',
      ...
      },
      {
        ...
        description: 'Carregue um ou mais vídeos de referência (upload ou galeria)',
        icon: '🎬',
        color: '#f59e0b',
      ...
      },
      {
        ...
        label: 'Produtos',
        description: 'Selecione um ou mais produtos cadastrados para usar como referência',
        icon: '📦',
        color: '#10b981',
      ...
      },
      {
        ...
        description: 'Selecione uma imagem salva na galeria do sistema. Para definir papel específico (produto/influencer/ambiente), use "Imagens de Referência".',
        icon: '📁',
        color: '#3b82f6',
      ...
      },
      {
        ...
        description: 'Roteiro cena a cena (quadro a quadro). Pode importar roteiros do Motor de Estratégia, inclusive de Reels.',
        icon: '🎞️',
        color: '#0ea5e9',
        defaultConfig: {
          scenes: [
