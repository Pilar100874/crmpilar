...
export const NODE_CATEGORIES: NodeCategory[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        description: 'Suba 1 ou várias imagens de referência (upload ou da galeria). Defina o papel (produto, pessoa, ambiente...) para a IA respeitar a prioridade.',
        icon: '🖼️',
        color: '#f97316',
      ...
      },
      {
        ...
        description: 'Suba 1 ou vários vídeos de referência (upload ou galeria).',
        icon: '🎬',
        color: '#f59e0b',
      ...
      },
      {
        ...
        label: 'Produtos',
        description: 'Selecione 1 ou vários produtos cadastrados (com lote = processamento múltiplo).',
        icon: '📦',
        color: '#10b981',
      ...
      },
      {
        ...
        description: 'Selecione imagem da galeria por categoria (Influencer, Ambiente, Estilo, Paleta, Textura, Logo, Pose, Roupa ou Salvas). A categoria define a prioridade na composição: Produto > Pessoa > Logo > Roupa > Pose > Ambiente.',
        icon: '🎭',
        color: '#3b82f6',
        defaultConfig: { categoria: 'salvas', selectedImageUrl: '', selectedImageName: '', galleryImageId: '' },
      },
      {
        type: 'textContent',
