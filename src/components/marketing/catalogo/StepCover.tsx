          ...
          <div className="space-y-3">
            ...
            {page.logoUrl ? (
              ...
              <button
                ...
                className="w-full h-24 border-2 border-dashed rounded-xl flex flex-col items-center justify-center gap-2 text-muted-foreground hover:text-foreground hover:border-primary/50 transition-colors"
              >
          ...
          <div className="space-y-3">
            ...
            {page.backgroundImage ? (
              ...
              >
                ...
                <span className="text-xs">Carregar imagem de fundo</span>
              </button>
            )}
          </div>
