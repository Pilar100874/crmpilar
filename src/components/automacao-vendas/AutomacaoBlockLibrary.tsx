                  ...
                  <div className="relative ml-5 pl-4 pt-1 pb-1">
                    ...
                    <div className="space-y-0.5">
                      {category.blocks.map((block) => {
                        const BlockIcon = Icons[(block as any).icon as keyof typeof Icons] as any;
                        return (
                        <Card
                          key={block.type}
                          draggable
                          onDragStart={(event) => { setBlockDragPreview(event, block.label, (block as any).color); onDragStart(event, block.type); }}
