...
export const GoodbyeConfigNew = ({ config, handleConfigChange, inputRefs, openVariablePicker }: ConfigProps) => {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label className="text-white-force">Mostrar Botões Sociais</Label>
          <Switch 
        ...
        {config.showSocialButtons && (
          <div className="ml-4 mt-3 space-y-2 border-l-2 border-muted pl-4">
            <div className="flex items-center justify-between">
              <Label className="text-sm text-white-force">WhatsApp</Label>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <Label className="text-sm text-white-force">Instagram</Label>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <Label className="text-sm text-white-force">Facebook</Label>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <Label className="text-sm text-white-force">Website</Label>
              <Switch 
