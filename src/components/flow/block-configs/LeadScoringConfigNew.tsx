          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                placeholder="score"
                className="pl-7 bg-foreground/90/80 border-slate-700/50 text-white placeholder:text-muted-foreground focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 shadow-inner font-medium"
              />
            </div>
            ...
            <div key={group.id || index} className="p-3 border border-cyan-500/30 rounded-lg bg-foreground/50 space-y-3 relative">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-16 bg-foreground/90/80 border-slate-700/50 text-white placeholder:text-muted-foreground focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 shadow-inner font-medium"
                />
              </div>
            </div>
          ))}
