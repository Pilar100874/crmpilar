          ...
          {keywords.map((keyword: any, index: number) => (
            <div key={keyword.id || index} className="flex items-center gap-2 p-3 rounded-lg bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/40">
              <Input
                ...
                className="flex-1 bg-foreground/90/80 border-slate-700/50 text-white placeholder:text-muted-foreground focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 shadow-inner"
              />
              <Button 
                variant="ghost" 
                size="icon" 
