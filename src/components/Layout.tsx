...
export const menuItems: MenuItem[] = [
...

  {
    ...
    subItems: [
      ...
      { id: "Portaria", title: "Interfone", url: "/portaria", icon: LucideIcons.ShieldCheck, group: "Portaria" },
      { id: "Portaria Painel", title: "Painel da Portaria", url: "/portaria/painel", icon: LucideIcons.LayoutDashboard, group: "Portaria" },
      { id: "Portaria Pendencias", title: "Pendências por Unidade", url: "/portaria/pendencias", icon: LucideIcons.ListChecks, group: "Portaria" },
      { id: "Portaria Relatorio Unidades", title: "Relatório por Unidade", url: "/portaria/relatorio-unidades", icon: LucideIcons.BarChart3, group: "Portaria" },
    ],
  },
  {
    id: "Automacao",
