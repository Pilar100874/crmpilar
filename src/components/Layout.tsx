...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { id: "Admin Atualizacoes Apps", title: "Atualizações dos Aplicativos", url: "/admin/apps/atualizacoes", icon: LucideIcons.RefreshCw },
            ...
            {menuLocked ? (
              <div className="relative w-full flex flex-col items-center gap-1">
                ...
                {avisosPendentes > 0 && (
                  <NavLink
                    to="/avisos"
                    className="flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold transition-colors bg-destructive text-destructive-foreground hover:bg-destructive/80"
