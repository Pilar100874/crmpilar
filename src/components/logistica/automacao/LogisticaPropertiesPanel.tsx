...
export function LogisticaPropertiesPanel({ selectedNode, onUpdateNode }: LogisticaPropertiesPanelProps) {
  ...
  if (!selectedNode) {
    return (
      <div className="w-80 flex flex-col h-[calc(100%-1rem)] m-2 rounded-2xl shadow-lg border-2 border-white dark:border-white/10 bg-gradient-to-b from-background to-muted/30 p-4 items-center justify-center">
  ...
  return (
    <div className="workflow-props w-80 h-[calc(100%-1rem)] m-2 rounded-2xl border-2 border-white dark:border-white/10 bg-gradient-to-b from-background to-muted/30 shadow-lg flex flex-col overflow-x-hidden">
