      ...
      <DialogContent className="max-w-6xl w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] max-h-[95vh] overflow-hidden flex flex-col p-0 gap-0">
        <DialogHeader className="p-4 sm:p-6 pb-3 border-b bg-muted/20">
          ...
          <div className="mt-3 rounded-md border border-amber-500/40 bg-amber-500/10 p-2 text-[11px] text-amber-900 dark:text-amber-200">
            ⚠️ A configuração do rastreador <b>só pode ser usada em chip M2M</b> instalado no equipamento.
            Em celular normal os comandos são apenas informativos e são ignorados pelo aparelho.
          </div>
