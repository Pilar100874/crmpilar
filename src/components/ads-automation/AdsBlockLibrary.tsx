...
export const AdsBlockLibrary = ({ onDragStart, isExpanded, onToggleExpanded }: AdsBlockLibraryProps) => {
  ...
  return (
    <div className="w-64 flex flex-col h-[calc(100%-1rem)] m-2 rounded-2xl shadow-lg border-2 border-white dark:border-white/10 bg-gradient-to-b from-muted/60 via-muted/25 to-background relative">
