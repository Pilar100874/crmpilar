...
export const AdsPropertiesPanel = ({ selectedNode, onUpdateNode, onClose }: AdsPropertiesPanelProps) => {
  ...
  return (
    <Card className="workflow-props w-80 h-[calc(100%-1rem)] m-2 rounded-2xl border-2 border-white dark:border-white/10 bg-gradient-to-b from-background to-muted shadow-lg flex flex-col overflow-x-hidden">
