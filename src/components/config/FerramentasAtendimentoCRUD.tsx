...
const DEFAULT_TOOLS = [
  ...
  { ferramenta_id: 'tool-agenda-email', nome: 'Rastreio com Agendamento', icone: 'Target', descricao: 'Link ou anexo que rastreia e agenda', tipo: 'ferramenta', aba_email: true, radial_email: true },
