    ...
    (async () => {
      ...
      setTimeout(() => {
        if (!closed && !liveReached) {
          setErro("Coletor não respondeu ao pedido de stream. Atualize para a versão 1.6.7+ do Coletor, mantenha o módulo de câmeras ativo e confirme se a câmera tem RTSP habilitado.");
          setStatus("erro");
        }
      }, 12_000);
