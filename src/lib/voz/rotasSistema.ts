...
export const ROTAS_SISTEMA: RotaSistema[] = [
  ...
  { path: "/portaria/painel", titulo: "Portaria - Painel", aliases: ["painel da portaria", "painel portaria"] },
  { path: "/portaria/pendencias", titulo: "Portaria - Pendências", aliases: ["pendencias da portaria", "pendencias portaria"] },
  ...
  { path: "/automacao/dispositivos", titulo: "Automação - Dispositivos", aliases: ["shelly", "idface", "dispositivos", "cadastro de dispositivos", "dispositivos automacao"] },
  ...
  { path: "/admin/apps/chaves", titulo: "Apps - Chaves do Aplicativo", aliases: ["chaves do aplicativo", "gerar chave do aplicativo", "ativacao dos aplicativos"] },
  ...
  { path: "/listas?tab=mapa-clientes", titulo: "Mapa", aliases: ["mapa dos clientes", "mapa de empresas", "mapa de clientes"] },
