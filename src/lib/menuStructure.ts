...
{ id: "Relatórios", title: "Relatórios", url: "/relatorios", icon: LucideIcons.FileText },
  {
    ...
    subItems: [
      ...
      { id: "Ponto Departamentos", title: "Departamentos", url: "/ponto/departamentos", icon: LucideIcons.Network },
      { id: "Ponto Cargos", title: "Cargos", url: "/ponto/cargos", icon: LucideIcons.Briefcase },
      { id: "Ponto Equipes", title: "Equipes", url: "/ponto/equipes", icon: LucideIcons.Users2 },
      { id: "Ponto Escalas", title: "Escalas e Jornadas", url: "/ponto/escalas", icon: LucideIcons.CalendarClock },
      ...
      { id: "Ponto Aprovacoes", title: "Aprovações", url: "/ponto/aprovacoes", icon: LucideIcons.CheckCircle2 },
      { id: "Ponto Espelho", title: "Espelho de Ponto", url: "/ponto/espelho", icon: LucideIcons.FileSignature },
      { id: "Ponto Pre Fechamento", title: "Pré-Fechamento", url: "/ponto/pre-fechamento", icon: LucideIcons.ClipboardCheck },
      { id: "Ponto Fechamento", title: "Fechamento Mensal", url: "/ponto/fechamento", icon: LucideIcons.Lock },
      { id: "Ponto Banco Horas", title: "Banco de Horas", url: "/ponto/banco-horas", icon: LucideIcons.PiggyBank },
      { id: "Ponto Ferias", title: "Férias e Afastamentos", url: "/ponto/ferias", icon: LucideIcons.Palmtree },
      { id: "Ponto Atestados", title: "Atestados (RH)", url: "/ponto/atestados-admin", icon: LucideIcons.Stethoscope },
      { id: "Ponto Equipamentos", title: "Equipamentos Control iD", url: "/ponto/equipamentos", icon: LucideIcons.Cpu },
      { id: "Ponto AFD", title: "AFD (Portaria 671)", url: "/ponto/afd", icon: LucideIcons.FileText },
      { id: "Ponto Layouts Exp", title: "Layouts de Exportação", url: "/ponto/layouts-exportacao", icon: LucideIcons.LayoutTemplate },
      { id: "Ponto Exportação", title: "Exportação para Folha", url: "/ponto/exportacao", icon: LucideIcons.FileDown },
      { id: "Ponto Dashboard Exec", title: "Dashboard Executivo", url: "/ponto/dashboard-executivo", icon: LucideIcons.BarChart3 },
      { id: "Ponto Alertas", title: "Alertas", url: "/ponto/alertas", icon: LucideIcons.ShieldAlert },
      { id: "Ponto Anomalias", title: "Anomalias CLT", url: "/ponto/anomalias", icon: LucideIcons.AlertTriangle },
      { id: "Ponto Compliance", title: "Dashboard Compliance", url: "/ponto/compliance", icon: LucideIcons.ShieldCheck },
      { id: "Ponto Banco Horas Exp", title: "Banco Horas a Expirar", url: "/ponto/banco-horas-expirar", icon: LucideIcons.Hourglass },
      { id: "Ponto eSocial", title: "eSocial - Transmissão", url: "/ponto/esocial", icon: LucideIcons.Send },
      { id: "Ponto eSocial Fila", title: "Fila eSocial (Retry/DLQ)", url: "/ponto/esocial-fila", icon: LucideIcons.RefreshCw },
      { id: "Ponto Aprovacao Regras", title: "Regras de Aprovação", url: "/ponto/aprovacao-regras", icon: LucideIcons.GitBranch },
      { id: "Ponto Sobreaviso", title: "Sobreaviso/Prontidão", url: "/ponto/sobreaviso", icon: LucideIcons.Bell },
      ...
      { id: "Ponto Notificacoes", title: "Notificações", url: "/ponto/notificacoes", icon: LucideIcons.BellRing },
      ...
      { id: "Ponto Config Hub", title: "Outras Configurações", url: "/ponto/config", icon: LucideIcons.Settings },
      { id: "Ponto Manual", title: "Manual do Sistema", url: "/ponto/manual", icon: LucideIcons.BookOpen },
    ],
  },
