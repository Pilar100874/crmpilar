...
export const menuStructure: MenuCategory[] = [
  ...
  { 
    ...
    subItems: [
      ...
      { id: "Config Estab Workflows", title: "Estabelecimento → Workflows Omnichannel", url: "/config?secao=cadastro-estabelecimentos&subsecao=atendimento&subsubsecao=workflows-omnichannel", icon: LucideIcons.Workflow },
      ...
      { id: "Config Estab Regras Orcamento", title: "Estabelecimento → Regras para o Orçamento", url: "/config?secao=cadastro-estabelecimentos&subsecao=regras-orcamento", icon: LucideIcons.Zap },
