...
{ id: "Relatórios", title: "Relatórios", url: "/relatorios", icon: LucideIcons.FileText },
  ...
  { 
    ...
    subItems: [
      ...
      { id: "Config Estabelecimento", title: "Estabelecimento Cadastrado", url: "/config?secao=cadastro-estabelecimentos", icon: LucideIcons.Store, group: "Estabelecimento" },
      { id: "Config Estab Resend", title: "Configuração Resend (Email)", url: "/config?secao=cadastro-estabelecimentos&subsecao=resend-config", icon: LucideIcons.Mail, group: "Estabelecimento" },
      { id: "Config Estab Unidades", title: "Cadastro de Unidades", url: "/config?secao=cadastro-estabelecimentos&subsecao=cadastro-unidades", icon: LucideIcons.Building2, group: "Estabelecimento" },
      { id: "Config Estab SLA", title: "SLA de Atendimento", url: "/config?secao=cadastro-estabelecimentos&subsecao=cadastro-sla", icon: LucideIcons.Clock, group: "Estabelecimento" },
      { id: "Config Estab Usuarios", title: "Usuários e Acessos", url: "/config?secao=cadastro-estabelecimentos&subsecao=usuarios-acessos", icon: LucideIcons.UserCog, group: "Estabelecimento" },
      { id: "Config Estab Grupos", title: "Grupos de Acesso", url: "/config?secao=cadastro-estabelecimentos&subsecao=usuarios-acessos&subsubsecao=grupos-acesso", icon: LucideIcons.FolderTree, group: "Estabelecimento" },
      { id: "Config Estab Cadastro Usuarios", title: "Cadastro de Usuários", url: "/config?secao=cadastro-estabelecimentos&subsecao=usuarios-acessos&subsubsecao=cadastro-usuarios", icon: LucideIcons.Users, group: "Estabelecimento" },
      ...
      { id: "Config Estab Comunicacao", title: "Comunicação", url: "/config?secao=comunicacao", icon: LucideIcons.Mail, group: "Estabelecimento" },
      { id: "Config Estab Integracoes", title: "Integrações", url: "/config?secao=integrações", icon: LucideIcons.Link2, group: "Estabelecimento" },
      { id: "Config Estab Sistema", title: "Sistema", url: "/config?secao=sistema", icon: LucideIcons.Settings, group: "Estabelecimento" },
      ...
      { id: "Config Estab Webhooks Entrada", title: "Webhooks de Entrada", url: "/config?secao=cadastro-estabelecimentos&subsecao=integracao-apis&subsubsecao=webhooks-entrada", icon: LucideIcons.Globe, group: "Estabelecimento" },
      { id: "Config Estab Seguranca", title: "Segurança", url: "/config?secao=cadastro-estabelecimentos&subsecao=integracao-apis&subsubsecao=seguranca", icon: LucideIcons.Shield, group: "Estabelecimento" },
      { id: "Config Estab Vendas", title: "Vendas", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas", icon: LucideIcons.DollarSign, group: "Estabelecimento" },
      { id: "Config Estab Tipo Pagamento", title: "Tipo de Pagamento", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=tipo-pagamento", icon: LucideIcons.CreditCard, group: "Estabelecimento" },
      { id: "Config Estab Tabelas Preco", title: "Tabelas de Preço", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=tabelas-preco", icon: LucideIcons.DollarSign, group: "Estabelecimento" },
      { id: "Config Estab Condicoes Pagamento", title: "Condição de Pagamento", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=condicoes-pagamento", icon: LucideIcons.Wallet, group: "Estabelecimento" },
      { id: "Config Estab Produtos", title: "Cadastro de Produtos", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=cadastro-produtos", icon: LucideIcons.Package, group: "Estabelecimento" },
      { id: "Config Estab Grupos Produtos", title: "Grupos de Produtos", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=grupos-produtos", icon: LucideIcons.FolderOpen, group: "Estabelecimento" },
      { id: "Config Estab Categorias Produtos", title: "Categorias de Produtos", url: "/config?secao=cadastro-estabelecimentos&subsecao=vendas&subsubsecao=categorias-produtos", icon: LucideIcons.Layers, group: "Estabelecimento" },
      { id: "Config Estab Regras Orcamento", title: "Regras para o Orçamento", url: "/config?secao=cadastro-estabelecimentos&subsecao=automacao-vendas", icon: LucideIcons.Zap, group: "Estabelecimento" },
