        ...
        <div className="flex-1 overflow-y-auto p-6">
          {agentsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-muted-foreground">
              ...
              <p className="text-lg font-medium">Nenhum agente disponível</p>
              <p className="text-sm">Configure seus agentes nas configurações de atendimento</p>
            </div>
          ) : (
              ...
              {activeAgents.map(agent => {
                ...
                return (
                  <button
                    ...
                    className="text-left rounded-2xl border-2 p-5 transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] group"
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Badge variant="outline" className="text-[10px] mt-0.5" style={{ borderColor: color + '40', color }}>
                          {agent.modelo_ia.split('/').pop()}
                        </Badge>
                      </div>
                    </div>
                    {agent.descricao && (
                    ...
                    <div className="mt-3 flex items-center gap-1.5 text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity" style={{ color }}>
      ...
      <div className="border-t p-4" style={{ background: agentColor + '05' }}>
        <div className="flex items-end gap-2">
          <Textarea
            ...
            placeholder={`Pergunte ao ${selectedAgent.nome}...`}
