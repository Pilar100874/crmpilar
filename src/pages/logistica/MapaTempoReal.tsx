...
import { List, Info, PanelLeftClose, PanelLeft } from 'lucide-react';
import { cn } from '@/lib/utils';
import { toast } from 'sonner';
import { useSearchParams } from 'react-router-dom';

const MapaTempoReal: React.FC = () => {
  ...
  return (
    <LogisticaLayout activeTab="mapa">
