    ...
    queryFn: async () => {
      ...
      const orcToInsert = (orcamentos || [])
        ...
        .map(o => ({
          ...
          origem: "orcamento",
          origem_id: o.id,
          numero_pedido: `ORC-${o.numero || o.id.slice(0, 8)}`,
          nome_cliente: o.cliente?.nome || o.nome_cliente || "Cliente",
          telefone_cliente: o.cliente?.telefone,
          email_cliente: o.cliente?.email,
          valor_total: o.valor_total || 0,
          valor_frete: o.valor_frete || 0,
          valor_desconto: o.desconto_valor || 0,
          forma_pagamento: o.condicao_pagamento,
