...
const TIPOS: TipoCriacao[] = [
  ...
  },
  {
    ...
    icone: Megaphone,
    passos: ["tipo", "basico", "referencias", "conhecimento", "ferramentas", "execucao", "agenda", "revisao"],
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Criar uma campanha de 4 mensagens (e-mail + WhatsApp) para reativar clientes inativos há mais de 90 dias, com oferta e chamada para ação.",
    dica: "Diga o público, a oferta e o tom da marca. Anexe exemplos de campanhas que funcionaram.",
    criaRotina: true,
  },
  {
    id: "reels",
    ...
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Gerar 3 reels de 20 segundos no formato 9:16 sobre os benefícios do produto, com legenda na tela e chamada final.",
    dica: "Envie fotos/vídeos do produto como referência e diga o gancho dos primeiros 3 segundos.",
    criaRotina: false,
  },
  {
    id: "proposta",
    ...
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Montar uma proposta comercial para o cliente X com escopo, prazos, investimento, diferenciais e condições de pagamento.",
    dica: "Anexe sua tabela de preços e um modelo de proposta antigo em .md ou PDF.",
    criaRotina: false,
  },
  {
    id: "analise_dados",
    ...
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Analisar a planilha de vendas do mês e apontar top produtos, quedas relevantes, clientes em risco e 3 recomendações.",
    dica: "Envie a planilha (CSV/Excel) nas referências e diga quais perguntas quer respondidas.",
    criaRotina: true,
  },
  {
    id: "automacao",
    ...
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Quando um orçamento for aprovado, avisar o financeiro por e-mail, criar a tarefa de entrega e mandar WhatsApp para o cliente.",
    dica: "Descreva o gatilho (o que inicia) e depois cada passo, em ordem, como uma receita.",
    criaRotina: false,
  },
  {
    id: "extracao",
    ...
    modelo: "claude-sonnet-4-5",
    exemploObjetivo:
      "Ler os PDFs de notas fiscais e devolver uma tabela com fornecedor, número, data, itens e valor total.",
    dica: "Envie 2 ou 3 documentos de exemplo e diga exatamente quais campos precisa na saída.",
    criaRotina: true,
  },
];
