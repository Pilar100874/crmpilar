                    ...
                    return (
                      <>
                        <tr key={contato.id} className="border-b border-border/30 hover:bg-muted/40 transition-colors duration-150 group">
                          <td className="p-3 sticky left-0 z-20 bg-card group-hover:bg-muted w-[36px] transition-colors duration-150">
                          ...
                          {visibleContatosColumns.map(col => {
                            if (col.id === "actions") {
                              return (
                                <td key={col.id} className="p-2 sm:p-3 sticky left-[36px] z-20 bg-card group-hover:bg-muted border-r border-border shadow-[4px_0_10px_-4px_hsl(var(--foreground)/0.18)] text-center transition-colors duration-150 whitespace-nowrap">
                                  <Button
                                    variant="outline"
                                    size="sm"
