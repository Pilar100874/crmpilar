...
const tabItems: TabItem[] = [
  { id: 'inbox', label: 'Caixa de Entrada', icon: Inbox, description: 'Mensagens recebidas', folder: 'inbox' },
  { id: 'sent', label: 'Enviados', icon: Send, description: 'Mensagens enviadas', folder: 'sent' },
  { id: 'archive', label: 'Arquivados', icon: Archive, description: 'Mensagens arquivadas', folder: 'archive' },
  { id: 'trash', label: 'Lixeira', icon: Trash2, description: 'Mensagens excluídas', folder: 'trash' },
];
