...
import { 
  ...
  Variable, Copy, Check, Image, Video, BookOpen, Paperclip, ArrowLeft, X
} from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { toast } from "@/lib/toast-config";
import { cn } from "@/lib/utils";
import { TemplateContentEditor, ContentItem } from "@/components/config/TemplateContentEditor";
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center text-muted-foreground">
              ...
              <p className="text-sm mt-1">Crie seu primeiro template para usar no envio em massa</p>
