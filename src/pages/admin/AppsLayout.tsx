...
import { Download, PackageCheck, PanelLeft, PanelLeftClose, Smartphone } from "lucide-react";
...
const itens = [
  ...
  { to: "/admin/apps/versoes", label: "Versões dos aplicativos", icon: PackageCheck, end: false },
];
