    ...
    >
      <div className="flex flex-1 h-full overflow-hidden">
        ...
        {selectedNode && !showSimulator && (
          <div className="w-80 h-[calc(100%-1rem)] m-2 rounded-2xl shadow-lg border-2 border-white dark:border-white/10 bg-gradient-to-b from-background to-muted/90 overflow-auto">
