...
const navItems: NavItem[] = [
  { to: "/manutencao", label: "Manutenções & Defeitos", icon: ClipboardCheck, end: true, group: "principal" },
  { to: "/manutencao/analise", label: "Análise de Manutenção", icon: Wrench, group: "principal" },
  { to: "/manutencao/biblioteca", label: "Biblioteca de Manutenção", icon: BookOpen, group: "config" },
  { to: "/manutencao/tipos-defeito", label: "Tipos de Defeito", icon: Tag, group: "config" },
];
      ...
      <div className="border-b bg-gradient-to-r from-primary/10 via-card to-card px-3 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <h1 className="text-lg sm:text-2xl font-bold truncate">Manutenção</h1>
            <p className="text-muted-foreground text-xs sm:text-sm mt-0.5 hidden sm:block">
              Ordens de serviço · Defeitos · Planos preventivos
            </p>
          </div>
        </div>
      </div>
