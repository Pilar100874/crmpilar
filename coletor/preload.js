...
contextBridge.exposeInMainWorld('coletor', {
  ...
  startPortaria: () => ipcRenderer.invoke('collector:startPortaria'),
  stopPortaria: () => ipcRenderer.invoke('collector:stopPortaria'),
  setPortariaToken: (token) => ipcRenderer.invoke('collector:setPortariaToken', token),
